...
const time_from = moment(data[4].value, "MMMM Do hhmm A").format('YYYY-MM-DDTHH:mm:ss')

const time_to = moment(data[5].value, "MMMM Do hhmm A").format('YYYY-MM-DDTHH:mm:ss')
// 2022-01-01T05:40:00
